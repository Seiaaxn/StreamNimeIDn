...
import AllAnimePage from './explorer/AllAnimePage';
import AllDonghuaPage from './explorer/AllDonghuaPage';

const ExplorerPage = ({ onAnimeSelect }) => {
    const [activeTab, setActiveTab] = useState('all-anime');

    const tabs = [
        { id: 'all-anime', label: 'All Anime', icon: Tv, component: AllAnimePage },
        { id: 'all-donghua', label: 'All Donghua', icon: Clapperboard, component: AllDonghuaPage },
    ...
    const ActiveComponent = tabs.find(t => t.id === activeTab)?.component || AllAnimePage;
